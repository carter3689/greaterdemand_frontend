...
const navigation = {
    ...
    support: [
      { name: 'Connect With Our Team', href: '/contact' },
      // { name: 'Guides', href: '#' },
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
            ...
            <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
              ...
              <div className="mt-4 rounded-md sm:mt-0 sm:ml-4 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-red-800 py-1.5 px-3 text-base font-semibold leading-7 text-white hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400 sm:text-sm sm:leading-6"
                >
                  Subscribe
                </button>
              </div>
          ...
          <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; 2023 Greater Demand, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
