        ...
        <div className="bg-gray-50 py-16 px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="mx-auto max-w-lg">
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              Please send us a message and someone from our team will contact you soon.
            </p>
            <dl className="mt-8 text-base text-gray-500">
              <div>
                <dt className="sr-only">Greater Demand Solutions</dt>
                <dd>
                  <p>1 Westbrook Corporate Center Suite 300</p>
                  <p>Westchester, IL 60154</p>
                </dd>
              </div>
              <div className="mt-6">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">708.223.0068</span>
                </dd>
              </div>
              <div className="mt-3">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">info@gds-brands.com</span>
                </dd>
              </div>
            </dl>
